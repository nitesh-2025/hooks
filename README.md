...
| [`skills/nitesh-designer/SKILL.md`](skills/nitesh-designer/SKILL.md) | Senior product designer standard — Figma-level structure, conventional → better → exceptional thinking, multi-persona review, UX psychology, information density, no trend-copying |
...
| [`hooks/skill-reminders.js`](hooks/skill-reminders.js) | UserPromptSubmit hook — bug/error prompts → `nitesh-bug-fix`, test/QA/regression prompts → `nitesh-tester`, feature/"banao" prompts → `nitesh-feature-dev`, workflow/production-ready prompts → `nitesh-dev-workflow`, design/UI/UX prompts → `nitesh-designer` |
